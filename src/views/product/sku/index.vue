<template>
    <el-card>
        <el-table border style="margin: 10px 0px;" :data="skuArr">
            ...
            <el-table-column label="名称" show-overflow-tooltip align="center" width="150px" prop="skuName"></el-table-column>
            <el-table-column label="描述" show-overflow-tooltip align="center" width="150px" prop="skuDesc"></el-table-column>
